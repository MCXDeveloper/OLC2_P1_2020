...
public class NMultiplicacion extends Nodo implements Instruccion {

    private Nodo opIzq;
    private Nodo opDer;

    public NMultiplicacion(int linea, int columna, String archivo, Nodo opIzq, Nodo opDer) {
        super(linea, columna, archivo, ETipoNodo.EXP_MULTIPLICACION);
        this.opIzq = opIzq;
        this.opDer = opDer;
    }
        ...
        if (opIzq != null && opDer != null) {
            ...
            if (v1.getTipoDato() == ETipoDato.INT && v2.getTipoDato() == ETipoDato.INT) {
                ...
                if (!Arrays.asList(tiposPermitidos).contains(tipoInternoVector)) {
                    msj = "Error. No hay implementación para la operación MULTIPLICACION para los tipos <VECTOR["+ tipoInternoVector +"]> y <"+ v2.getTipoDato() +">.";
                ...
                if (!Arrays.asList(tiposPermitidos).contains(tipoInternoVector)) {
                    msj = "Error. No hay implementación para la operación MULTIPLICACION para los tipos <"+ v1.getTipoDato() +"> y <VECTOR["+ tipoInternoVector +"]>.";
                    ErrorHandler.AddError(getTipoError(), getArchivo(), "[N_MULTIPLICACION]", msj, getLinea(), getColumna());
                } else {
                    NPrim op2;
                    Resultado r;
                ...
                if (vec1.getVectorSize() == vec2.getVectorSize()) {
                    ...
                    msj = "Error. Los tamaños de los vectores difieren por lo que no se puede realizar la multiplicación.";
                    ErrorHandler.AddError(getTipoError(), getArchivo(), "[N_MULTIPLICACION]", msj, getLinea(), getColumna());
                }
                ...
                */
                ...
                if (mat1.getSize() == mat2.getSize()) {
                    ...
                    msj = "Error. Las dimensiones de la matriz difieren por lo que no se puede realizar la multiplicación.";
                    ErrorHandler.AddError(getTipoError(), getArchivo(), "[N_MULTIPLICACION]", msj, getLinea(), getColumna());
                }

            } else {
                msj = "Error. No hay implementación para la operación MULTIPLICACION para los tipos <"+ v1.getTipoDato() +"> y <"+ v2.getTipoDato() +">.";
                ErrorHandler.AddError(getTipoError(), getArchivo(), "[N_MULTIPLICACION]", msj, getLinea(), getColumna());
            }
    ...
    public String GenerarDOT(TablaSimbolos ts) {
        ...
        String subson = ts.getDeclararNodo("NODO_MULTIPLICACION");
